...
export function Info() {
  ...
  return (
    <div className='grid w-full max-w-7xl grid-cols-3 gap-y-2 font-notoSerif text-sm text-black-100 sm:flex sm:justify-between lg:text-base'>
      ...
      <form
        className='col-span-full flex max-w-4xl gap-4 justify-self-center sm:col-auto'
